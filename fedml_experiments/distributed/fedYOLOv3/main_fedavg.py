...
def add_args(parser):
    ...
    parser.add_argument("--model_def", type=str, default="/FedML/fedml_api/model/YOLOv3/config/yolov3.cfg", help="path to model definition file")
    parser.add_argument("--data_config", type=str, default="/FedML/fedml_api/model/YOLOv3/config/coco.data", help="path to data config file")
    parser.add_argument("--data_path", type=str, default = "/FedML/fedml_api/model/YOLOv3/coco")
