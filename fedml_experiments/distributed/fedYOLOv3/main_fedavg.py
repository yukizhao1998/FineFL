...
from fedml_api.model.YOLOv3.models import Darknet
from fedml_api.distributed.fedavg.FedAvgAPI import FedML_init, FedML_FedAvg_distributed
from fedml_api.model.YOLOv3.YOLOv3Trainer import YOLOv3Trainer
from fedml_api.model.YOLOv3.YOLOv3ResultAggregator import YOLOv3ResultAggregator
...
def add_args(parser):
    ...
    parser.add_argument("--model_def", type=str, default="/FineFL/fedml_api/model/YOLOv3/config/yolov3.cfg", help="path to model definition file")
    parser.add_argument("--data_config", type=str, default="/FineFL/fedml_api/model/YOLOv3/config/coco.data", help="path to data config file")
    parser.add_argument("--data_path", type=str, default = "/FineFL/fedml_api/model/YOLOv3/coco")
...
def create_model(args):
    logging.info("YOLOv3 + coco")
    config_path = '/FedML/fedml_api/model/YOLOv3/config/yolov3.cfg'
